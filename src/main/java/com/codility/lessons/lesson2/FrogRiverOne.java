...
/**
 * 100/100 level: Easy Problem: We need to know when all elements from sequence
 * 1..X already appeared, so we need to iterate over input array when there is
 * new element we have to keep it somewhere, boolean array seems to be the
 * faster way since I don't need to fill it just happen automatically while
 * creating new array.
 *
