...
/**
 * 100/100 level: Medium Problem: problem here is expected worst-case time
 * complexity O(N+M), normally we could just iterate over input array and when
 * there is max counter we could fill our result array otherwise increase given
 * value. Since filling huge array worst-case: 100 000 elements with 100 000
 * times gives us complexity O(N*M) that means performance is an issue.
 *
