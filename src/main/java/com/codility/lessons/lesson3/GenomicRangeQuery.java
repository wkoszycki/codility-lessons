...
/**
 * level: Medium, score: 100/100, Point is that we need to know which letter
 * occured in asked sequence, we can prepare a a double table to store
 * information about number of occurences, then we can use our prefixSUm Ninja
 * knowledge to ask about occurence of specific element
 *
